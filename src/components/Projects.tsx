...
const Projects: FC = () => {
    ...
    return (
        <section id="Proyectos" className="pt-10 pb-15 bg-[var(--neutral-1o40-smjd)]">
            <div className="container mx-auto px-4">
                <h2 className="text-[var(--primary-smjd)] text-2xl font-bold text-center mb-12">Proyectos</h2>
