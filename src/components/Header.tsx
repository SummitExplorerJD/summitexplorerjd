    ...
    render() {
        return (
            <header className="flex flex-row items-center justify-between bg-[var(--accent-2-smjd)] p-5">
                ...
                <div>
                    <a rel="noopener" href="https://chat.whatsapp.com/C0Y2WdpsOIm9kch9WKgnAo" target="_blank" className="inline-block rounded-full border border-[var(--neutral-1-smjd)] bg-[var(--neutral-1-smjd)] p-3 text-[var(--accent-2-smjd)] hover:bg-[var(--accent-2-smjd)] hover:text-[var(--neutral-2-smjd)] focus:outline-none focus:ring active:text-indigo-500" aria-label="Unirse a comunidad de WhatsApp" >
